...
class UrlHandlerFlow {
    ...
    async trigger({ scopes, baseUri, redirectUri, callbackUri, enterpriseUri, nonce, signInProvider, uriHandler, existingLogin, logger, }) {
...
class LocalServerFlow {
    ...
    async trigger({ scopes, baseUri, redirectUri, callbackUri, enterpriseUri, signInProvider, existingLogin, logger }) {
...
class DeviceCodeFlow {
    ...
    async trigger({ scopes, baseUri, signInProvider, logger }) {
