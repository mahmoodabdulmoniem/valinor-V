...
exports.createContractFiles = exports.generateActionItemsFromContract = exports.extractRequirementsFromContract = exports.generateActionItemsContent = exports.generateEnhancedRequirementsContent = exports.generateRequirementsContent = exports.generateAttachmentsContent = exports.generateCostBreakdown = exports.generateCompanyProfile = exports.generateWorkBreakdown = exports.generateMethodology = exports.generateBackgroundContext = exports.generateContractOverview = exports.generateExecutiveSummary = void 0;
...
function generateExecutiveSummary(contractData) {
...
function generateContractOverview(contractData) {
...
${contractData.pointOfContact && contractData.pointOfContact.length > 0
        ? contractData.pointOfContact.map((contact, index) => `### Contact ${index + 1}
- **Name**: ${contact.name || 'N/A'}
- **Email**: ${contact.email || 'N/A'}
- **Phone**: ${contact.phone || 'N/A'}`).join('\n\n')
...
exports.generateContractOverview = generateContractOverview;
// Function to generate background context
function generateBackgroundContext(contractData) {
...
exports.generateBackgroundContext = generateBackgroundContext;
// Function to generate methodology
function generateMethodology(contractData) {
...
exports.generateMethodology = generateMethodology;
// Function to generate work breakdown
function generateWorkBreakdown(contractData) {
...
exports.generateWorkBreakdown = generateWorkBreakdown;
// Function to generate company profile
function generateCompanyProfile(contractData) {
...
exports.generateCompanyProfile = generateCompanyProfile;
// Function to generate cost breakdown
function generateCostBreakdown(contractData) {
...
function generateAttachmentsContent(attachments) {
...
exports.generateAttachmentsContent = generateAttachmentsContent;
// Function to generate requirements content
function generateRequirementsContent(contractData) {
...
exports.generateRequirementsContent = generateRequirementsContent;
// Enhanced requirements analysis with detailed action items
function generateEnhancedRequirementsContent(contractData) {
...
${requirements.technical.map((req, index) => `${index + 1}. **${req.title}**
   - **Requirement**: ${req.description}
   - **Priority**: ${req.priority}
   - **Complexity**: ${req.complexity}`).join('\n\n')}

### 🏢 Business Requirements
${requirements.business.map((req, index) => `${index + 1}. **${req.title}**
   - **Requirement**: ${req.description}
   - **Priority**: ${req.priority}
   - **Impact**: ${req.impact}`).join('\n\n')}

### 📋 Compliance Requirements
${requirements.compliance.map((req, index) => `${index + 1}. **${req.title}**
   - **Requirement**: ${req.description}
   - **Standard**: ${req.standard}
   - **Deadline**: ${req.deadline}`).join('\n\n')}

### 🎯 Deliverables Required
${requirements.deliverables.map((del, index) => `${index + 1}. **${del.title}**
...
${requirements.criticalFactors.map((factor, index) => `${index + 1}. ${factor}`).join('\n')}

---
*Enhanced Analysis Generated on ${new Date().toLocaleDateString()}*
`;
}
exports.generateEnhancedRequirementsContent = generateEnhancedRequirementsContent;
// Generate detailed action items
function generateActionItemsContent(contractData) {
...
${actionItems.immediate.contact.map((action, index) => `${index + 1}. **${action.title}**
...
${actionItems.immediate.documentation.map((action, index) => `${index + 1}. **${action.title}**
   - **Action**: ${action.description}
...
${actionItems.technical.infrastructure.map((action, index) => `${index + 1}. **${action.title}**
   - **Action**: ${action.description}
...
${actionItems.technical.development.map((action, index) => `${index + 1}. **${action.title}**
   - **Action**: ${action.description}
...
### 💰 Financial Planning
${actionItems.business.financial.map((action, index) => `${index + 1}. **${action.title}**
   - **Action**: ${action.description}
...
${actionItems.business.partnerships.map((action, index) => `${index + 1}. **${action.title}**
   - **Action**: ${action.description}
...
${actionItems.compliance.regulatory.map((action, index) => `${index + 1}. **${action.title}**
   - **Action**: ${action.description}
...
${actionItems.compliance.security.map((action, index) => `${index + 1}. **${action.title}**
   - **Action**: ${action.description}
...
${actionItems.metrics.map((metric, index) => `${index + 1}. **${metric.title}**
   - **Target**: ${metric.target}
   - **Measurement**: ${metric.measurement}
   - **Frequency**: ${metric.frequency}`).join('\n\n')}

## 🚨 Risk Mitigation Actions
${actionItems.risks.map((risk, index) => `${index + 1}. **${risk.title}**
...
exports.generateActionItemsContent = generateActionItemsContent;
// Extract requirements from contract data
function extractRequirementsFromContract(contractData) {
...
exports.extractRequirementsFromContract = extractRequirementsFromContract;
// Generate action items from contract data
function generateActionItemsFromContract(contractData) {
    return {
        immediate: {
            contact: [
                {
...
exports.generateActionItemsFromContract = generateActionItemsFromContract;
// Create comprehensive folder structure with all files
async function createContractFiles(contractData, workspaceFolder, output) {
    try {
...
exports.createContractFiles = createContractFiles;
