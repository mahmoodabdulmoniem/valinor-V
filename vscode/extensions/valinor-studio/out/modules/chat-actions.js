...
exports.SleekIcons = exports.ChatActionProvider = void 0;
const vscode = __importStar(require("vscode"));
class ChatActionProvider {
    constructor(output) {
        this.output = output;
    }
    // Generate auto-fixes for code issues
    async generateAutoFixes(document, selectedText) {
        const fixes = [];
    ...
    async generateInChatCreations(context) {
        const creations = [];
    ...
    async generateChatActions(context) {
        const actions = [];
    ...
    findTextRange(document, searchText) {
...
Our experienced team will provide dedicated project management and ensure seamless communication throughout the contract period.`;
    ...
    generateTechnicalApproachTemplate() {
...
• **Regular Assessment**: Ongoing risk evaluation and updates`;
    ...
    generateComplianceMatrixTemplate() {
