...
exports.VersionPanelProvider = void 0;
const vscode = __importStar(require("vscode"));
const path = __importStar(require("path"));
class VersionPanelProvider {
    constructor(_extensionUri, versionManager) {
    ...
    async handleLoadVersionHistory() {
        await this.refreshVersionHistory();
    }
    async handleRestoreVersion(commitHash) {
    ...
    async handleShowDiff(fromHash, toHash) {
        const editor = vscode.window.activeTextEditor;
        if (!editor) {
            vscode.window.showWarningMessage('No active editor');
            return;
    ...
    async handleCreateVersion(message) {
        const editor = vscode.window.activeTextEditor;
        if (!editor) {
            vscode.window.showWarningMessage('No active editor');
            return;
    ...
    async showDiffEditor(diff, fromHash, toHash) {
    ...
    formatDiffContent(diff, fromHash, toHash) {
...
exports.VersionPanelProvider = VersionPanelProvider;
VersionPanelProvider.viewType = 'valinorStudio.versionPanel';
//# sourceMappingURL=version-panel.js.map