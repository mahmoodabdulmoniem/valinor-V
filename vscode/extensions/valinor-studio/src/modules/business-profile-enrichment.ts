...
export class BusinessProfileEnrichment {
	...
	registerCommands(context: vscode.ExtensionContext) {
		const insertCompanyProfileCommand = vscode.commands.registerCommand(
			'valinorStudio.insertCompanyProfile',
			async () => {
	...
	private async getBusinessProfileData(): Promise<CompanyProfileData | null> {
		try {
	...
	private async showProfileConfirmationModal(profileData: CompanyProfileData): Promise<CompanyProfileData | null> {
	...
	private generateConfirmationModalHTML(profileData: CompanyProfileData): string {
		return `
			<!DOCTYPE html>
			<html>
			<head>
	...
	private async generateAndInsertCompanyProfile(editor: vscode.TextEditor, profileData: CompanyProfileData) {
		try {
	...
	// Generate the company profile content
	private generateCompanyProfileContent(profileData: CompanyProfileData): string {
