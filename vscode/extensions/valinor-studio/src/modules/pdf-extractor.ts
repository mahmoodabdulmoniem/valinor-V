...
export interface ExtractedRFPDocument {
	title: string;
	noticeId?: string;
...
export class PDFExtractor {
	...
	public async extractRFPFromPDF(filePath: string): Promise<ExtractedRFPDocument> {
	...
	public async parseRFPDocument(rawText: string, filePath: string, fileSize: number): Promise<ExtractedRFPDocument> {
	...
	private extractNoticeId(text: string): string | undefined {
	...
	private extractSolicitationNumber(text: string): string | undefined {
	...
	private generateDescription(text: string, title: string): string {
	...
	private getTechnicalRFPSample(): string {
...
Attachment C - Performance Standards`;
	...
	private getServicesRFPSample(): string {
		return `REQUEST FOR PROPOSAL
...
Attachment C - Past Performance Requirements`;
	...
	private getStandardRFPSample(): string {
		return `REQUEST FOR PROPOSAL
...
Attachment C - Contract Terms`;
	...
	public async createAnalysisFile(rfpDocument: ExtractedRFPDocument, workspaceFolder: vscode.WorkspaceFolder): Promise<void> {
	...
	private generateAnalysisContent(rfpDocument: ExtractedRFPDocument): string {
