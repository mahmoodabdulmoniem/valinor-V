...
exports.Operation = {
    ...
    DeleteWorktree: { kind: "DeleteWorktree" /* OperationKind.DeleteWorktree */, blocking: false, readOnly: false, remote: false, retry: false, showProgress: true },
    ...
    GetWorktrees: { kind: "GetWorktrees" /* OperationKind.GetWorktrees */, blocking: false, readOnly: true, remote: false, retry: false, showProgress: false },
    ...
    Worktree: { kind: "Worktree" /* OperationKind.Worktree */, blocking: false, readOnly: false, remote: false, retry: false, showProgress: true }
};
